...
{
    int fila, columna = 0;
    int barcosRestantes = 5; // Inicialmente, hay 4 barcos en el tablero
    ...
    do
    {
        ...
        if (int.TryParse(Console.ReadLine(), out fila) && fila >= 0 && fila <= 4)
        {
            ...
            if (int.TryParse(Console.ReadLine(), out columna) && columna >= 0 && columna <= 4)
            {
                ...
                {
                    Console.WriteLine("Se ha alcanzado el límite de intentos permitidos. Fin del juego.");
                    break; // Salir del bucle del juego
                }
            ...
            {
                Console.WriteLine("La columna invalida, ingrese un valor numérico entre 0 y 4.");
            }
        }
        else
        {
            Console.WriteLine("La fila invalida, ingrese un valor numérico entre 0 y 4.");
        }
    } while (true);
